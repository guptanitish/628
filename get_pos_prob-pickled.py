...
pos_tags_index_mapper_path = "/home/stufs1/nitigupta/628/pickled_ds2/pos_tags_index_mapper.txt"
word_index_mapper_path = "/home/stufs1/nitigupta/628/pickled_ds2/word_index_mapper.txt"
#path = "/home/stufs1/nitigupta/628/data/train_v2_9719648.txt" #path to the tagged file
#path = "/home/stufs1/nitigupta/628/data/train_v2_100000.txt" #path to the tagged file
test_data_path = "/home/stufs1/nitigupta/628/data/test_v2_tagged_smp.txt"
bi_word_path = "/home/stufs1/nitigupta/628/pickled_ds2/bi_word.txt" #bigram word to word dict
bi_arr_path = "/home/stufs1/nitigupta/628/pickled_ds2/bi_arr.txt" #bigram pos to pos arr
tri_arr_path = "/home/stufs1/nitigupta/628/pickled_ds2/tri_arr.txt" #trigram pos to pos arr
pos_prob_path = "/home/stufs1/nitigupta/628/pickled_ds2/pos_prob_path.txt" #pos prob dict
word_pos_path = "/home/stufs1/nitigupta/628/pickled_ds2/word_pos_path.txt" #prev word to cur pos prob dict
pos_word_dict_path = "/home/stufs1/nitigupta/628/pickled_ds2/pos_word_dict.txt" #wprd to pos prob dict
word_curpos_path = "/home/stufs1/nitigupta/628/pickled_ds2/pos_curword_dict.txt" #cur wprd to cur pos prob dict
output_path = "/home/stufs1/nitigupta/628/pickled_ds2/sents_with_predict_tags.txt" #cur wprd to cur pos prob dict
...
save_to_disk(pos_tags_index_mapper, pos_tags_index_mapper_path)
print "@@@The tag index is done@@@@"
# <codecell>
...
save_to_disk(word_index_mapper, word_index_mapper_path)
print "@@@The word index is done@@@@"
# <codecell>
...
print "@@@writing word_tag_arr @@@@"
save_to_disk(word_tag_arr,word_curpos_path)
'''
print "@@@Starting tri_arr @@@@"
# <codecell>
...
try:
  inputFile = open(test_data_path, 'r');
except:
  print "Cant open file";
  sys.exit(0);

print "\n##############\nStarting to work on the test file\n################\n"
...
for i in range(L_test_data):
        if ((test_data_df[0][i] == "." or test_data_df[0][i] == "?") and test_data_df[1][i] == "."):
            if(isinstance(test_data_df[0][i+1], str) == False):
              if (np.isnan(test_data_df[0][i+1])):
		...
		i = i + 1
              ...
              #print count
              print count, test_data_df[0][i], test_data_df[0][i+1], test_data_df[0][i+2]
...
for line in sents:
    ...
    for i in range(1,len(line)):
        ...
        total_prob = prob_prevtag_given_curtag + prob_curtag_given_prevtag + prob_curtag_given_prevtwotags + prob_curtag_given_prevword
    ...
    list1.append(('mis__sin', max_prob_tag))
    list2 = line[local_pos:]
    new_line = list1 + list2
    output.append(new_line)

print "\n##############\nDone with finding the location\n################\n"
...
for line in tagged_sents:
    ...
    #print line
    local_max = 0
    missing_word = "mis__sin"
    missing_tag = ""
    local_pos = 0
    new_line = []
    for i in range(1,len(line)):
        (cur_word, cur_tag) = line[i]
        if (cur_word == "mis__sin"):
...
print "\n##############\nDone with predicting the words\n################\n"
out_path = "/home/stufs1/nitigupta/628/data/final_submission_kaggle.txt"    
## try to open the file ##
try:
  f = open(out_path, 'w')
except:
...
print "\n##############\nWriting the result onto the final_submission_kaggle file\n################\n"
